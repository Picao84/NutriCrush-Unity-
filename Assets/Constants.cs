...
public static class Constants
{
    ...
    public static readonly Dictionary<TutorialMessagesEnum, List<string>> TutorialMessages = new Dictionary<TutorialMessagesEnum, List<string>>
    {
        ...
        { TutorialMessagesEnum.ToddlerTier, new List<string> { "Con-cat-ulations!, you are in for a promotion!", "You can now skip and shuffle your food!" } },
        { TutorialMessagesEnum.ChildTier, new List<string> { "You really showed everyone who's boss-cat!", "Watch out though, leaving the food out too long is a real fur-ustration!" } },
        { TutorialMessagesEnum.TeenTier, new List<string> { "You’re feline almost like a grown-up now!", "Make combos to sum calories faster than ever!" } },
        { TutorialMessagesEnum.YoungAdultTier, new List<string> { "Look at you, all grown up and meow-mature", "Take advantage of new food benefits to reach your goals!" } },
